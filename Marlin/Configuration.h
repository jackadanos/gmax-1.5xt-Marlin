...
#define STRING_CONFIG_H_AUTHOR "(Jack Danos, gMax 1.5 XT with dual extruder and BLTouch)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  56.67,  65.62 }
    #define DEFAULT_Ki_LIST {   7.95,   7.42 }
    #define DEFAULT_Kd_LIST { 100.97, 145.14 }
  #else
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 15, 1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38.5, -12, -2.5 }
 ...
 */
// Automatically saves leveling data to EEPROM
